...
> [!WARNING]
> This is a development branch. Use [main](https://github.com/SteveOv/sed_fit) for 'stable', pre-release code.
...
While the [fitting-a-sed-new.ipynb](../main/fitting-a-sed-new.ipynb) jupyter page is not
